...
class SignalProcessor:
    ...
    def propose_portfolio_trades(
        ...
        Receives every ticker's final_trade_decision at once and produces
        portfolio-level allocation with fact-based reasoning per stock.

        Args:
            ticker_signals: {ticker: final_trade_decision_text}
    ...
    @staticmethod
    def execute_order(
        order_params: dict, api_key: str, secret_key: str
    ) -> str:
        """
